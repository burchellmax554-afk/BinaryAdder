...
BL IOShieldInit //initialization
BL SwAnalysis //Finds the 2 values to be added
BL LEDWriteMain //Adds the 2 values and finds the correct execution from this
B main
...
cmp r4, #9
bgt InvalidNumber
//Getting the 2 switch values
mov r2,0x0
mov r4,0x0
bfi r2,r3,#0,#4 //Value 1 is in r2
asr r3,#4
bfi r4,r3,#0,#4 //Value 2 is in r4
cmp r1, #18 //Not actually needed but is a failsafe
bgt InvalidNumber
bx lr

/******************************************************************************************/
LEDWriteMain:
/*Analyzes which output program to go with and executes it*/
mov r3, #0 //clear r3
add r3, r2, r4 //2 values added (r3 is the total)
cmp r3, #9
bgt LEDDecimal //r3>10 && r3<=18
B LEDWrite //>=0 && <10
bx lr
/*****************************************************************************************/

LEDDecimal://Value to display if over 10

sub r3,r3,#10 //Get r3 down to the correct range

ldr r0,=SegTable2 //SegTable 2 enables the decimal point
ldrb r3,[r0,r1]
...
LEDWrite:
ldr r0,=SegTable1 //SegTable1 is used as <10
ldrb r3,[r0,r1]
...
InvalidNumber: //r2,r4>9
ldr r0,=SegTable3 //This hex turns only B18 on
ldrb r3,[r0,r1]
...
SegTable3:.byte 0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF,0xBF
.section .bss
